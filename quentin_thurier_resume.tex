  ...
  \resumeSubheading
    ...
    \resumeItemListStart
      \resumeItemBis{Develop and maintain Decoded Health's AI medical resident deployed in urgent care clinics}{.}
        \resumeItemBis{} {Prompt engineering, Few-shot learning, R\&D on \emph{named entity recognition} and clinical \emph{text generation} using large language models - Establishing standards for data versioning and ML-based services monitoring - Taking part in the on-call schedule}
          \resumeItemListEnd
