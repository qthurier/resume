  ...
  \resumeSubheading
    ...
    \resumeItemListStart
      \resumeItemBis{Develop and maintain Decoded Health's AI medical resident deployed in urgent care clinics}{.}
        \resumeItemBis{} {Prompt engineering, Few-shot learning, Retrieval-augmented generation, R\&D on \emph{named entity linking} and clinical \emph{text generation} using large language models - Establishing standards for data versioning, ML-based services experimentation and monitoring - Taking part in the on-call schedule}
          \resumeItemListEnd
