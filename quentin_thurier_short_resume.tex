...
\resumeItemListNoBulletStart
\resumeItem {\color{darkgray}{Surveyed 1000+ physicians to investigate the association between physician understanding of machine learning outputs, their ability to explain these to patients, and their willingness to trust these, using various explainability methods. This article has been cited 98 times.}}
\resumeItemListEnd \vspace{0.2cm}
...
\resumeItemListNoBulletStart
\resumeItem {\color{darkgray}{Introduced a promising avenue to improve medication reconciliation, hence patient safety, by achieving 81\% accuracy with a deep learning model trained to automatically parse medication dosage instructions.}}
\resumeItemListEnd \vspace{0.2cm}
...
\resumeItemListNoBulletStart
\resumeItem {\color{darkgray}{Suggested a modelling workflow to facilitate the use of model agnostic explainability methods and applied this to a machine learning mortality risk model.}}
\resumeItemListEnd \vspace{0.2cm}
\paper {Interpretable machine learning for healthcare}{https://ebooks.hinz.nz/view/564876691/113/}{HINZ}{2018}
\resumeItemListNoBulletStart
\resumeItem {\color{darkgray}{Showed how the Python data science stack can be used to help clinicicans to audit black-box machine learning models, using the example of a hospital risk readmission model.}}
\resumeItemListEnd \vspace{0.2cm}
