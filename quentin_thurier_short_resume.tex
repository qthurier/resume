...
\resumeItemListNoBulletStart
\resumeJustifiedItem {\color{darkgray}{Introduced a promising avenue to improve medication reconciliation, hence patient safety, by achieving 81\% accuracy with a deep learning model trained to automatically parse medication dosage instructions.}}
\resumeItemListEnd \vspace{0.2cm}
...
\resumeItemListNoBulletStart
\resumeJustifiedItem {\color{darkgray}{Showed how the Python data science stack can be used to help clinicicans to audit black-box machine learning models, using the example of a hospital risk readmission model.}}
\resumeItemListEnd \vspace{0.2cm}
...
\resumeItemListNoBulletStart
\resumeJustifiedItem {\color{darkgray}{Demonstrated the effectiveness of transfer learning for clinical named entity recognition by training a deep learning model on a heuristically labelled large dataset then fine-tuning it with a manually annotated dataset and comparing its performance with clinical concept extraction softwares.}}
\resumeItemListEnd \vspace{0.2cm}
\paper {Health outcomes prediction engine for stroke}{https://ebooks.hinz.nz/view/565138579/47/}{HINZ}{2017}
\resumeItemListNoBulletStart
\resumeJustifiedItem {\color{darkgray}{Presented how machine learning can aid the communication of prognosis by training an ensemble classifier on 5 years of stroke hospital records that achieved an area under the ROC curve of 94\% when predicting inpatient death outcomes.}}
\resumeItemListEnd \vspace{0.2cm}
\paper {New Zealand health data review}{https://ebooks.hinz.nz/view/565138579/65/}{HINZ}{2017}
\resumeItemListNoBulletStart
\resumeItem {\color{darkgray}{Made health data easier to access for research by reviewing publicly available datasets and their relationships.}}
\resumeItemListEnd 
