...
\paper {Physician understanding, explainability, and trust in a hypothetical ML risk calculator}{https://pubmed.ncbi.nlm.nih.gov/32106285/}{JAMIA}{2019} %98
\resumeItemListNoBulletStart
\resumeItem {\color{gray}{This paper has been quoted 98 times.}}
\resumeItemListEnd \vspace{0.2cm}
\paper {Smart MedRec: Using ML for reading dose instructions and incorporating this in clinical software}{https://ebooks.hinz.nz/view/564619932/38/}{HINZ}{2019}
\resumeItemListNoBulletStart
\resumeItem {\color{gray}{Showed how an ensemble classifier trained on 5 years of stroke hospital records can predict inpatient health coutcomes.}}
\resumeItemListEnd \vspace{0.2cm}
\paper {Inspecting a ML-based clinical risk calculator: a practical perspective}{https://ieeexplore.ieee.org/abstract/document/8787409}{IEEE}{2019}
\resumeItemListNoBulletStart
\resumeItem {\color{gray}{Showed how an ensemble classifier trained on 5 years of stroke hospital records can predict inpatient health coutcomes.}}
\resumeItemListEnd \vspace{0.2cm}
\paper {Interpretable ML for healthcare}{https://ebooks.hinz.nz/view/564876691/}{HINZ}{2018}
\resumeItemListNoBulletStart
\resumeItem {\color{gray}{Showed how an ensemble classifier trained on 5 years of stroke hospital records can predict inpatient health coutcomes.}}
\resumeItemListEnd \vspace{0.2cm}
...
\resumeItem {\color{gray}{Showed how an ensemble classifier trained on 5 years of stroke hospital records can predict inpatient health coutcomes.}}
\resumeItemListEnd \vspace{0.2cm}
\paper {Health outcomes prediction engine for stroke}{https://ebooks.hinz.nz/view/565138579/}{HINZ}{2017}
\resumeItemListNoBulletStart
\resumeItem {\color{gray}{Showed how an ensemble classifier trained on 5 years of stroke hospital records can predict inpatient health coutcomes.}}
\resumeItemListEnd \vspace{0.2cm}
\paper {New Zealand health data review}{https://ebooks.hinz.nz/view/565138579/}{HINZ}{2017}
\resumeItemListNoBulletStart
\resumeItem {\color{gray}{Reviewed publicly available health datasets in New Zealand and make them accessible to researchers.}}
\resumeItemListEnd 
